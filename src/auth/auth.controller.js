...
var AuthController = function () {
    var _classDecorators = [(0, common_1.Controller)('signin')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _testGet_decorators;
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.testGet = function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            data = signInDto.data;
                            return [4 /*yield*/, this.auth.signIn(data)];
                        case 1:
                            jwtToken = _a.sent();
                            res.status(200).send(__assign({}, jwtToken));
    ...
    (function () {
        ...
        _testGet_decorators = [(0, common_1.Get)()];
        _signIn_decorators = [(0, common_1.Post)()];
        __esDecorate(_classThis, null, _testGet_decorators, { kind: "method", name: "testGet", static: false, private: false, access: { has: function (obj) { return "testGet" in obj; }, get: function (obj) { return obj.testGet; } }, metadata: _metadata }, null, _instanceExtraInitializers);
